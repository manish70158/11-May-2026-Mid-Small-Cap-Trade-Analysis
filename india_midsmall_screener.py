...
# Correct Nifty Midcap 100 constituents (as of May 2026)
# Source: NSE India official data
NIFTY_MIDCAP_100 = [
    '360ONE', 'APLAPOLLO', 'AUBANK', 'ATGL', 'ABCAPITAL', 'ALKEM',
    'ASHOKLEY', 'ASTRAL', 'AUROPHARMA', 'BSE', 'BANKINDIA', 'BDL',
    'BHARATFORG', 'BHEL', 'GROWW', 'BIOCON', 'BLUESTARCO', 'COCHINSHIP',
    'COFORGE', 'COLPAL', 'CONCOR', 'COROMANDEL', 'DABUR', 'DIXON',
    'EXIDEIND', 'NYKAA', 'FEDERALBNK', 'FORTIS', 'GVT&D', 'GMRAIRPORT',
    'GLENMARK', 'GODFRYPHLP', 'GODREJPROP', 'HAVELLS', 'HEROMOTOCO', 'HINDPETRO',
    'POWERINDIA', 'HUDCO', 'ICICIGI', 'ICICIAMC', 'IDFCFIRSTB', 'INDIANB',
    'IRCTC', 'IREDA', 'INDUSTOWER', 'INDUSINDBK', 'NAUKRI', 'JSWENERGY',
    'JUBLFOOD', 'KEI', 'KPITTECH', 'KALYANKJIL', 'LTF', 'LGEINDIA',
    'LICHSGFIN', 'LAURUSLABS', 'LENSKART', 'LUPIN', 'MRF', 'M&MFIN',
    'MANKIND', 'MARICO', 'MFSL', 'MOTILALOFS', 'MPHASIS', 'MCX',
    'NHPC', 'NMDC', 'NATIONALUM', 'OBEROIRLTY', 'OIL', 'PAYTM',
    'OFSS', 'POLICYBZR', 'PIIND', 'PAGEIND', 'PATANJALI', 'PERSISTENT',
    'PHOENIXLTD', 'POLYCAB', 'PREMIERENE', 'PRESTIGE', 'RADICO', 'RVNL',
    'SBICARD', 'SRF', 'SAIL', 'SUPREMEIND', 'SUZLON', 'SWIGGY',
    'TATACOMM', 'TATAELXSI', 'TATAINVEST', 'TIINDIA', 'UPL', 'VMM',
    'IDEA', 'VOLTAS', 'WAAREEENER', 'YESBANK',
]

# Correct Nifty Smallcap 100 constituents (as of May 2026)
# Source: NSE India official data
NIFTY_SMALLCAP_100 = [
    'AARTIIND', 'ABREL', 'AEGISLOG', 'AFCONS', 'AFFLE', 'ARE&M',
    'AMBER', 'ANANDRATHI', 'ANANTRAJ', 'ANGELONE', 'APTUS', 'ASTERDM',
    'ATHERENERG', 'BEML', 'BLS', 'BANDHANBNK', 'FIRSTCRY', 'BRIGADE',
    'CESC', 'CGCL', 'CASTROLIND', 'CDSL', 'CHAMBLFERT', 'CHOLAHLDNG',
    'CUB', 'COHANCE', 'CAMS', 'CREDITACC', 'CROMPTON', 'DATAPATTNS',
    'DEEPAKFERT', 'DELHIVERY', 'DEVYANI', 'LALPATHLAB', 'FSL', 'FIVESTAR',
    'FORCEMOT', 'GRSE', 'GLAND', 'GPIL', 'GESHIP', 'GMDCLTD',
    'HBLENGINE', 'HSCL', 'HINDCOPPER', 'IDBI', 'IFCI', 'IIFL',
    'IRCON', 'ITI', 'IGL', 'INOXWIND', 'IKS', 'JBMA',
    'JMFINANCIL', 'JSWCEMENT', 'JYOTICNC', 'KARURVYSYA', 'KAYNES', 'KEC',
    'KFINTECH', 'MANAPPURAM', 'MRPL', 'MEESHO', 'NATCOPHARM', 'NBCC',
    'NH', 'NAVINFLUOR', 'NETWEB', 'NEULANDLAB', 'NUVAMA', 'OLAELEC',
    'PGEL', 'PNBHOUSING', 'PWL', 'PINELABS', 'PIRAMALFIN', 'PPLPHARMA',
    'POONAWALLA', 'RBLBANK', 'REDINGTON', 'RPOWER', 'SAGILITY', 'SAILIFE',
    'SARDAEN', 'SIGNATURE', 'SONACOMS', 'STARHEALTH', 'SWANCORP', 'SYNGENE',
    'TATACHEM', 'TATATECH', 'TENNIND', 'RAMCOCEM', 'TRITURBINE', 'URBANCO',
